...
'''麻雀搜索算法'''
def SSA(fun,pop,dim,Max_iter,lb,ub):
    ST = 0.6 #预警值
    ...
    for i in range(Max_iter):
        ...
        if (i % 1 == 0):
            print(['迭代次数为' + str(i) + ' 的迭代结果' + str(GbestScore)])  # 每一次的迭代结果
        # print("The best solution obtained by SSA is : " + str(GbestPositon))
        # print("The best optimal value of the objective funciton found by SSA is : " + str(GbestScore))
